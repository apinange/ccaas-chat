        ...
        boxShadow:'0px 0px 2px rgba(0,0,0,0.25)'}}>
            <Stack p={3} spacing={2} sx={{maxHeight:'100vh'}}>
                ...
                <Stack direction={'row'} alignItems={'center'} justifyContent={'space-between'}>
                    <Typography variant='subtitle2' component={Link}>Criar Novo Grupo</Typography>
                ...
                <Stack spacing={3} className='scrollbar'  sx={{flexGrow:1, overflowY:'scroll', height:'100%'}}>
                    <SimpleBarStyle  timeout={500} clickOnTrack={false}>
                        <Stack spacing={2.5}>
                            {/*  */}
                            <Typography variant='subtitle2' sx={{color:'#676667'}}>Fixados</Typography>
                            {/* Pinned */}
                            {ChatList.filter((el)=> el.pinned).map((el)=>{
                              ...
                              {/*  */}
                              <Typography variant='subtitle2' sx={{color:'#676667'}}>Todos os Grupos</Typography>
                            {/* Chat List */}
                            {ChatList.filter((el)=> !el.pinned).map((el)=>{
                                return <ChatElement  {...el}/>
                            })}
